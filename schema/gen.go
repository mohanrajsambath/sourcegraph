...
//go:generate $PWD/.bin/go-jsonschema-compiler -o schema.go -pkg schema critical.schema.json site.schema.json settings.schema.json github.schema.json otherExternalService.schema.json
