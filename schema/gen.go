...
//go:generate $PWD/.bin/go-jsonschema-compiler -o schema.go -pkg schema awsCodeCommit.schema.json bitbucketServer.schema.json critical.schema.json site.schema.json settings.schema.json github.schema.json gitolite.schema.json otherExternalService.schema.json
